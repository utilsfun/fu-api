...
public class JsonRpcResult extends JSONObject {

	private static final long serialVersionUID = -3307140375714924531L;

	public static JsonRpcResult genResult(String id, Object retObj) {

		if (retObj instanceof JsonRpcResult) {
			return (JsonRpcResult) retObj;
		}
